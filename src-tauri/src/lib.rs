...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::dictionary_source_cmd::get_dict_sources,
            commands::dictionary_source_cmd::update_dict_source,
            commands::dictionary_source_cmd::lookup_word_all_sources,
            commands::dictionary_source_cmd::save_dict_sources,
