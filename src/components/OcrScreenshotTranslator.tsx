...
function isOcrSingleWord(text: string): boolean {
...
function hasRealDictionaryMeanings(results: DictionaryResult[]): boolean {
...
function formatOcrDictBody(word: string, results: DictionaryResult[]): string | null {
