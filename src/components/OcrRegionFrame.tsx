  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {displayMode === "translation" ? tf("common.targetText", "译文") : tf("common.sourceText", "原文")}
        </button>
        ...
        <button
          ...
          title={continuous ? tf("ocrRegion.pauseRefresh", "暂停自动刷新") : tf("ocrRegion.resumeRefresh", "开启自动刷新")}
        >
      ...
      <div className="absolute overflow-hidden" style={{ top: TOOLBAR_HEIGHT, left: 0, right: 0, bottom: 0 }}>
        {/* Loading state */}
        {loading && !error && (
        ...
        {data && displayMode === "translation" && data.translatedText && (!data.lineTranslations || data.lineTranslations.length === 0) && bounds && (
          <div
            ...
            style={{
              ...
              maxWidth: Math.min((bounds.width / scaleFactor) + 8, window.innerWidth - (bounds.x / scaleFactor) - 8),
            }}
          >
            ...
            {data.ocrLines.map((line) =>
              line.width > 0 && line.height > 0 ? (
                <div
                  ...
                  style={{ left: line.x / scaleFactor, top: (line.y / scaleFactor) - 2, maxWidth: (line.width / scaleFactor) + 4 }}
                >
                  {line.text}
                </div>
              ) : null,
