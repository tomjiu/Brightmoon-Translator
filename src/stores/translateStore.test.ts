...
describe("translateStore", () => {
  ...
  describe("incrementalStore", () => {
    it("should clear incremental entries", () => {
      useIncrementalStore.setState({
        incrementalEntries: [
          { id: "1", sourceText: "Hello", results: [], timestamp: Date.now() },
        ],
      });
  ...
  describe("historyStore", () => {
    ...
    it("should not go before first translation", () => {
      useTranslateStore.setState({ historyIndex: 0 } as any);
    ...
    it("should go to next translation", () => {
      useTranslateStore.setState({ historyIndex: 1 } as any);
    ...
    it("should not go past last translation", () => {
      useTranslateStore.setState({ historyIndex: 2 } as any);
  ...
  describe("embeddedStore", () => {
    ...
    it("should handle error", async () => {
      ...
      vi.mocked(safeInvoke).mockResolvedValue([
        null,
        { code: "ERR", message: "Embedded failed" },
      ]);
